...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $images = [
            ...
            'https://gun.deals/sites/default/files/kel-tec-rdbc20blk-tactical-rifles_3.jpg',
            ...
            'https://www.spenlo.com/image/cache/catalog/products/Lizol/Lizol-Stronger-Jasmine-Fragrance-Cleaner-500ML-700x700.jpg',
        ];
        ...
        return [
            ...
            'weight' => $this->faker->randomFloat(2, 0, 15),
            'sizes' => $this->faker->numberBetween(1, 150). 'x'. $this->faker->numberBetween(1, 150),
